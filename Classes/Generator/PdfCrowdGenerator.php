...
class PdfCrowdGenerator implements PdfGeneratorInterface
{
    ...
    public function __construct(array $options)
    {
        ...
        if (!isset($options['username'])) {
            throw new \Exception('You need to configure you\'r a username in "Famelo.Pdf.DefaultGeneratorOptions.username".');
        }
        if (!isset($options['apiKey'])) {
            throw new \Exception('You need to configure you\'r a apiKey in "Famelo.Pdf.DefaultGeneratorOptions.apiKey".');
        }
